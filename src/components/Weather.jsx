...
const Weather = ({ weatherInfo, handleSubmmit }) => {
    ...
    return (
        ...
        <div className='flex justify-around items-center p-2 sm:pt-8'>
            <span className='text-5xl text-[#026EED] dark:text-[#ffffff] font-clima min-[400px]:text-6xl sm:text-7xl'>{isCelcius ? kelvinToCelcius(weatherInfo?.main.temp) : kelvinToFahrenheit(weatherInfo.main.temp)}</span>
        ...
        <div className='flex flex-col pl-2 mb-3 font-clima sm:pl-4'>
            <span className='text-[#56A5F1] text-left dark:text-[#9977fa] min-[400px]:text-xl'>viento: {weatherInfo?.wind.speed}</span>
            <span className='text-[#56A5F1] text-left dark:text-[#9977fa] text-base min-[400px]:text-xl'>nubes: {weatherInfo?.main.humidity}</span>
            <span className='text-[#56A5F1] text-left dark:text-[#9977fa] min-[400px]:text-xl'>precion: {weatherInfo?.main.pressure}hPa</span>
        </div>
